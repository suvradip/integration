FusionCharts.ready(function () {
    var visitChart = new FusionCharts({
        ...
        dataSource: {
            ...
            /**
             * @description
             * Triggered every time a zoom line chart is zoomed out or zoomed in.            *
             * @param {Object} eventObj: An object containing all the details related to this event like eventId, sender, etc.
             * @param {Object} dataObj: An object containing all the details related to the zoomed data, such as the index of the starting and ending data points in the zoomed view.
             */

                "zoomed": function (eventObj, dataObj) {
