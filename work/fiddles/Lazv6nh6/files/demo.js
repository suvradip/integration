FusionCharts.ready(function () {
    var railwayChart = new FusionCharts({
        ...
        dataSource: {
            ...
            /**
             * @description
             * This event is triggered when the ajax POST request for sending user-submitted data in interactive charts (select-scatter, drag-node, and dragable charts) to the URL is successfully completed.
             *
             * @param {Object} evt: An object containing all the details related to this event like eventId, sender, etc.
             * @param {Object} data: An object containing all the details related to data submission like the url to which the data is sent, actual data being sent, response from server, and the xhr object.
             */
                "dataSubmitted": function (eventObj, dataObj) {
