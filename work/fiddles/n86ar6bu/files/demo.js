FusionCharts.ready(function () {
    var visitChart = new FusionCharts({
        ...
        dataSource: {
            ...
            /**
             * @description
             * Triggered every time a zoom line chart switches between the pin mode and the zoom mode.            *
             * @param {Object} eventObj: An object containing all the details related to this event like eventId, sender, etc.
             * @param {Object} dataObj: An object containing all the details related to the zoom mode.
             */

                "zoomModeChanged": function (eventObj, dataObj) {
