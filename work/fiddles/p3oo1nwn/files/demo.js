FusionCharts.ready(function () {
    var railwayChart = new FusionCharts({
        ...
        dataSource: {
             ...
             * @param {Object} dataObj: An object containing all the details related to the node, such as the label of the  node, its radius, number of sides, and so on.
             */

                "nodeUpdated": function (eventObj, dataObj) {
