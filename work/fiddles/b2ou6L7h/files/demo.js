FusionCharts.ready(function () {
    ...
    /**
     * @description
     * The getViewStartIndex() method returns the index of the first visible data point (in order of its definition in the source data) on the canvas of a zoom line chart.
     *
     * usage: visitChart.getViewStartIndex();     *         
     */
    function getViewStartIndex() {
        var index = visitChart.getViewStartIndex();
        document.getElementById("msg").innerHTML = index;

    }
    document.getElementById("get_index").addEventListener("click", getViewStartIndex);
});