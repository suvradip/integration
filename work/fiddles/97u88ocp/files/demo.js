FusionCharts.ready(function () {
    ...
    /**
     * @description
     * The zoomOut() method zooms out the zoom line chart by one level.
     * usage: chartObj.zoomOut();
     *         
     */
    ...
    visitChart.addEventListener("zoomedIn", activeZoomOut);
    visitChart.addEventListener("zoomedOut", dactiveZoomOut);
