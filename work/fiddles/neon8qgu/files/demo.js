FusionCharts.ready(function () {
    ...
    /**
     * @description
     * The resetChart() method resets all the zooming, panning, and pinning actions performed on a zoom line chart.
     * usage: chartObj.resetChart();
     *         
     */
    var reset_btn = document.getElementById("reset");

    function reset() {
        visitChart.resetChart();
    }
    ...
    function dActiveReset() {
        reset_btn.disabled = true;
    }
    reset_btn.addEventListener("click", reset);
    visitChart.addEventListener("zoomedIn", activeReset);
    visitChart.addEventListener("zoomReset", dActiveReset);
});