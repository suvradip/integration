FusionCharts.ready(function () {
    var visitChart = new FusionCharts({
        ...
        dataSource: {
             ...
             * @param {Object} dataObj: An object containing all the details related to the data points being pinned, such as the start and end index of the data points in the pinned mode.
             */

                "pinned": function (eventObj, dataObj) {
