FusionCharts.ready(function () {
    var smoPlan = new FusionCharts({
        ...
        dataSource: {
             ...
             * @param {Object} dataObj: An object containing all the details related to the milestone, such as the milestone date, ID of the milestone task, and so on.
             */

                "milestoneClick": function (evt, data) {
