FusionCharts.ready(function () {
        ...
        dataSource: {
            "chart": {
                "caption": "Unique Website Visitors",
                    ...
                    "dataseparator": "|",
                    "labelHeight": "30",
                //Limiting the maximum no. of labels
                "numVisibleLabels": "12",
                    "theme": "fint",
                    "captionFontSize": "13",
    ...
    /**
     * @description
     * The setZoomMode() method switches between the zoom mode and pin mode of a zoom line chart programmatically.
     * @param {Boolean} yes: Set to true to activate the zoom mode, set to false to activate the pin mode
     * 
     *  usage: chartObj.setZoomMode(false);       
     */
    var mode = document.getElementById("mode");

    function change() {
        if (mode.value == "pin") {
            visitChart.setZoomMode(false);
        } else {
            visitChart.setZoomMode(true);
        }
    }
