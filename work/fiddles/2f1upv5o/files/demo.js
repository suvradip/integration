FusionCharts.ready(function () {
    var revenueChart = new FusionCharts({
        ...
        events: {
            ...
            /**
             * @description
             * The resizeCancelled event is triggered when the eventObj.preventDefault() method is called from within the beforeResize event.
             *
             * @param {Object} eventObj: An object containing all the details related to this event like eventId, sender, etc.
             * @param {Object} dataObj: An object containing all the details related to the chart resize, such as the cancelled width and height.
             */

                "resizeCancelled": function (eventObj, dataObj) {
