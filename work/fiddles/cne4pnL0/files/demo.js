FusionCharts.ready(function () {
    var railwayChart = new FusionCharts({
        ...
        dataSource: {
             ...
             * @param {Object} dataObj: An object containing all the details related to data submission like the url to which the data is sent, http status, status text, actual data being sent, and the xhr object.
             */
                "dataSubmitError": function (eventObj, dataObj) {
