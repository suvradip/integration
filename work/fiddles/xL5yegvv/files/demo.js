FusionCharts.ready(function () {
    ...
    productPriceChart = new FusionCharts({
        ...
        dataSource: {
            ...
            /**
             * @description
             * Triggered when you complete drawing a selection box on a select-scatter chart.
             *
             * @param {Object} eventObj: An object containing all the details related to this event like eventId, sender, etc.
             * @param {Object} dataObj: An object containing all the details related to chart data such as the starting x and y position of the selection box, width and height of the box, etc.
             */

                "selectionEnd": function (eventObj, dataObj) {
