FusionCharts.ready(function () {
    var visitChart = new FusionCharts({
        ...
        dataSource: {
            ...
            /**
             * @description
             * Triggered every time a zoom line chart is zoomed in.            *
             * @param {Object} eventObj: An object containing all the details related to this event like eventId, sender, etc.
             * @param {Object} dataObj: An object containing all the details related to the zoomed in data, such as the index of the starting and ending data points in the zoomed view.
             */

                "zoomedIn": function (eventObj, dataObj) {
